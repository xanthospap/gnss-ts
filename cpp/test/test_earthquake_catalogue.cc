...
int main(int argc, char* argv[]) {
  ...
  // random date
  datetime<milliseconds> rand_t(year(2007), month(9), day_of_month(20), hours(23), minutes(1), milliseconds(13000));
  ...
  // random late date ....
  datetime<milliseconds> rand_t2(year(2071), month(9), day_of_month(20), hours(23), minutes(1), milliseconds(13000));
  // go to random epoch in file, and print the first earthquake after that
