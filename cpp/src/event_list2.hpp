#ifndef __NGPT_EVENT_LIST2_HPP__
#define __NGPT_EVENT_LIST2_HPP__
...
private:
  ngpt::datetime<ngpt::milliseconds> m_epoch; ///< Instance (epoch) the event took place
...
public:
  ...
  ///                  datetime<ngpt::milliseconds>::min() is passed in (which is the default
  ...
  ///                  datetime<ngpt::milliseconds>::max() is passed in (which is the default
